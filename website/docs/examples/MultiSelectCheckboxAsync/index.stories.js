...
const MultiSelectCheckboxAsyncStories = {
  title: "MultiSelectCheckboxAsync",
};

export default MultiSelectCheckboxAsyncStories;
...
export function MultiSelectCheckboxAsync() {
