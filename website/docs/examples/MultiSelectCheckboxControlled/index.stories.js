...
const MultiSelectCheckboxControlledStories = {
  title: "MultiSelect Checkbox Controlled",
};

export default MultiSelectCheckboxControlledStories;
...
export function MultiSelectCheckboxControlled() {
