...
| `defaultDisabledIds`     | `array`       | `[]`          | Array with the ids of the default disabled nodes. Please note that all children of a disabled node will also be disabled.                                                                                                                          |
...
| `disabledIds`            | `array`       | `[]`          | (Controlled) Array with the id of nodes that should be disable. Please note that all children of a disabled node will also be disabled.                                                                |
